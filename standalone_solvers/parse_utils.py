...
from mdss.models import MDSSInstance

def parse_instance_file(filepath: str) -> MDSSInstance:
    ...
    return MDSSInstance(vectors=vectors, target=target, n=len(vectors), d=d)
